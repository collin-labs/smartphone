...
const t = e => Ao.asset("/projects/smartphone/apps/" + e);
...
get gps() {
    var e;
    return null != (e = Ws("gps")[1]) ? e : Ao.asset("/projects/smartphone/apps/waze.webp")
},
get phone() {
    var e;
    return null != (e = Ws("phone")[1]) ? e : Ao.asset("/projects/smartphone/apps/phone.pn")
},
get facetime() {
    var e;
    return null != (e = Ws("facetime")[1]) ? e : Ao.asset("/projects/smartphone/apps/facetime.webp")
}
};
...
request(e = !1, t = "/") {
    return Ao.localhost ? Promise.resolve(e ? "https://i.pinimg.com/564x/a6/d4/30/a6d4302b399cc1dc1e682f08f20bf2f4.jpg" : "https://c.wallhere.com/photos/b1/5e/GTA5_GTA_Online_GTA_Landscape_GTA_Photography_trees_sunrise_Grand_Theft_Auto_V_Grand_Theft_Auto_V_Online-1945677.jpg!d") : (ro.start(), Ao.pusher.once("CONFIRM_SCREENSHOT", (async () => {
        ...
        const e = new Audio(Ao.asset("/projects/smartphone/sons/photo.ogg"));
...
created() {
    this.backend.getSettings().then((e => {
        ...
        this.contacts.value = n, this.sortContacts(), Object.assign(this.settings, l), l.isAndroid && (document.documentElement.style.fontFamily = "Roboto"), Xs.length = 0, Ys(), l.forceBackground ? this.backgroundURL = l.backgroundURL : this.backgroundURL || (this.backgroundURL = l.backgroundURL || this.asset("/projects/smartphone/stock/wallpapers/default.webp"))
    })), this.settings.zoom = parseInt(localStorage.getItem("smartphone@zoom")) || 100, this.updateZoom(), this.localhost && (this.settings.case = "iphone14pro", this.settings.isAndroid = !1, document.documentElement.style.fontFamily = "Roboto", this.settings.backgroundURL = this.asset("/projects/smartphone/stock/wallpapers/wallpaper.jpg"), this.settings.bankType = "bb", this.identity = {
        name: "Jester",
        firstname: "Iruka",
        user_id: 1,
        phone: "111-111"
...
name: gc[iM],
url: Ao.asset(`/projects/smartphone/stock/wallpapers/${iM}.webp`)
};
const vc = {};
...
key: 1,
class: "rounded-xl",
src: e.$asset("/projects/smartphone/stock/maps.jpg"),
...
const Zp = {
    ...
    setup() {
        ...
        const e = jl("alert"),
            ...
            s = rt(Ao.asset("/projects/smartphone/stock/user.webp"));
        return Tn(a, (e => Ao.storage.set("whatsapp-sensitive", String(e)))), Ao.backend.wpp_getProfile().then((e => {
            s.value = e.avatarURL || Ao.asset("/projects/smartphone/stock/user.webp"), n.value = !!e.read_receipts, t.value = !1
    ...
    setup() {
        ...
        function h(e) {
            ...
            return {
                ...
                phone: e,
                name: Bs(e),
                avatarURL: d[e] || Ao.asset("/projects/smartphone/stock/user.webp"),
                message: t,
        ...
        return xf.loaded || xf.ready(), {
            ...
            getAvatar: function (e) {
                var t;
                return null != (t = d[e]) ? t : Ao.asset("/projects/smartphone/stock/user.webp")
            }
        }
    },
    activated() {
...
const rh = {
    ...
    setup() {
        ...
        p.value || (d.startsWith("group") ? p.value = {
            ...
            name: d,
            unknown: !0,
            avatarURL: Ao.asset("/projects/smartphone/stock/user.webp")
        }), Ao.getPlayerCoords().then((e => r.value = e)), Ao.backend.wpp_getChat(d).then((e => {
            p.value.id = e.id, e.name && (p.value.name = e.name), p.value.avatarURL = e.avatarURL || Ao.asset("/projects/smartphone/stock/user.webp"), o.value = e.messages.map(f), Lt((() => m(!0)))
        }));
        let h = 0;
...
return wl(), _l("div", vy, [xy, Pl("div", yy, [(null == (o = l.tweet) ? void 0 : o.id) ? (wl(), _l("div", ky, [Pl("div", wy, [Pl("img", {
    ...
    key: 0,
    class: "ml-2 w-6 h-6"
})) : Ml("", !0)]), Pl("h1", Ay, "@" + g(l.tweet.author.username), 1)])]), Pl("p", Sy, g(l.tweet.content), 1), Pl("p", Ty, g(l.hour) + " · " + g(l.date) + " · Twitter for " + g(l.android ? "BahamasOID" : "BahamasOS"), 1), Pl("div", Ry, [Pl("p", Ey, [Pl("b", Py, g(l.tweet.retweets), 1), Ly]), Pl("p", Iy, [Pl("b", Oy, g(l.tweet.likes), 1), My])])])) : Ml("", !0), Pl("div", Vy, [Pl("button", {
...
return wl(), _l("div", {
    ...
    key: 4,
    class: "h-12 mx-auto",
    src: e.$asset("projects/smartphone/stock/fleeca_hand.png"),
    alt: ""
}, null, 8, ["src"])) : "nxbank" == l.bankType ? (wl(), _l("img", jk)) : "CPBank" == l.bankType ? (wl(), _l("img", {
    key: 6,
    class: "h-12 mt-4 mx-auto",
    src: e.$asset("projects/smartphone/apps/cpbank.svg")
}, null, 8, ["src"])) : "picpay" == l.bankType ? (wl(), _l("img", {
    key: 7,
    class: "h-14 mt-2 mx-auto",
    src: e.$asset("projects/smartphone/stock/picpay.svg")
}, null, 8, ["src"])) : "bdc" == l.bankType ? (wl(), _l("img", {
    key: 8,
    class: "h-24 mx-auto",
    src: e.$asset("projects/smartphone/apps/bdc.svg")
...
return wl(), _l("div", PT, [Pl("button", null, [Pl("img", {
    src: e.$asset("/projects/smartphone/stock/tinder/flame.png", "tinderFlame"),
    class: "w-10",
    style: {
    ...
    src: e.$asset("/projects/smartphone/stock/tinder/heart.png"),
    class: "w-10",
    style: {
    ...
    src: e.$asset("/projects/smartphone/stock/tinder/chat.png"),
    class: "w-10",
    style: {
    ...
    src: e.$asset("/projects/smartphone/stock/tinder/user.png"),
    class: "w-10",
    style: {
...
return wl(), _l("div", IT, [Pl(o), l.peer && "object" == typeof l.peer ? (wl(), _l("div", OT, [Pl("div", MT, [Pl("img", {
    ...
    src: e.$asset("/projects/smartphone/stock/tinder/redo.png"),
    class: "h-16"
}, null, 8, ["src"])])) : Ml("", !0), Pl("button", {
    onClick: t[2] || (t[2] = e => l.next(0))
}, [Pl("img", {
    src: e.$asset("/projects/smartphone/stock/tinder/refuse.png"),
    class: "h-16"
}, null, 8, ["src"])]), Pl("button", {
    onClick: t[3] || (t[3] = e => l.next(2))
}, [Pl("img", {
    src: e.$asset("/projects/smartphone/stock/tinder/star.png"),
    class: "h-16"
}, null, 8, ["src"])]), Pl("button", {
    onClick: t[4] || (t[4] = e => l.next(1))
}, [Pl("img", {
    src: e.$asset("/projects/smartphone/stock/tinder/like.png"),
    class: "h-16"
}, null, 8, ["src"])])])])) : (wl(), _l("div", HT, [Pl("img", {
    src: e.$asset("/projects/smartphone/stock/tinder/heartbreak.svg"),
...
return wl(), _l("div", JT, [l.payload.image ? (wl(), _l("div", ZT, [Pl("img", {
    ...
    src: e.$asset("/projects/smartphone/stock/tinder/logo.svg", "tinderLogo"),
    style: {
        filter: "invert(0.4)"
    }
...
return wl(), _l("div", wR, [Pl(o), l.likes && !l.likes.length ? (wl(), _l("div", CR, [Pl("img", {
    src: e.$asset("/projects/smartphone/stock/tinder/dislike.svg"),
    class: "w-2/3 mx-auto"
...
return wl(), _l(bl, null, [Pl("div", mL, [Pl("div", bL, [Pl("div", gL, [vL, Pl("div", xL, [(wl(!0), _l(bl, null, fa(l.lastColors, ((t, n) => (wl(), _l("div", {
    ...
    key: 0,
    class: "w-4",
    src: e.$asset("projects/smartphone/apps/blaze.webp", "casinoLogo"),
    alt: ""
...
return wl(), _l(bl, null, [Pl(Ja, {
    ...
    default: IO((() => [l.call && l.call.accepted && !l.visible ? (wl(), _l("li", OO, [Pl("img", {
        src: e.$asset("/projects/smartphone/apps/phone.png"),
    ...
    default: IO((() => [Zn(Pl("div", FO, [Pl("img", {
        class: "case",
        type: l.phonecase,
        src: e.$asset(`/projects/smartphone/stock/cases/${l.phonecase}.png`)
